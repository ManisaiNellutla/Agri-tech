    ...
    return (
        <Container className="main" fluid>
            ...
            <p className="description">
                Our smart farming platform offers crop and fertilizer recommendations, crop disease detection using ML, a multilingual chatbot (English, Telugu, Hindi) for agricultural queries, and a buy/sell marketplace for farmers. It empowers farmers with AI-driven insights, real-time support, and seamless trading to enhance productivity and profitability in agriculture.
